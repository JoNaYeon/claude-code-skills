---
name: work_ai_pm-planning-workflow
...
## 5-1. Skill Definition — /work_ai_mission-control (/관제)
...
- Set up 2 pipelines:
  ...
  2. Mission Control: /work_ai_mission-control (status/ingest/sync/triage/add)
...
- /work_ai_mission-control: Configure backlog.md, backlog-sync.json, Todoist MCP (mcp-remote OAuth), meeting note paths, and Obsidian mirror path
